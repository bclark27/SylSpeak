...
class GoetiaSigilDrawer:
    def __init__(self):
        self.ring_drawer = GoetiaSigilRingDrawer()
        self.poly_drawer = GoetiaSigilPolyDrawer()
        self.rune_drawer = GoetiaRuneDrawer()
